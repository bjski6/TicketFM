...
insert into InstallationType (name) value ("HVAC (ogrzewanie, wentylacja, chłodnictwo");
insert into InstallationType (name) value ("Instalacje elektryczne i oświetleniowe");
insert into InstallationType (name) value ("Systemy przeciwpożarowe");
insert into InstallationType (name) value ("Instalacje wodno-kanalizacyjne");
insert into InstallationType (name) value ("Budynek");
insert into InstallationType (name) value ("Tereny zewnętrzne");
insert into InstallationType (name) value ("Inne");
